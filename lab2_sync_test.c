...
void my_test() {
	...
	// node->data = 1;
	// enqueue(node);
	// queue_node* node1 = (queue_node*)malloc(sizeof(queue_node));
	// node1->data = 2;
	// enqueue(node1);
	// queue_node* node2 = (queue_node*)malloc(sizeof(queue_node));
	// node2->data = 3;
	// enqueue(node2);
	// queue_node* node3 = (queue_node*)malloc(sizeof(queue_node));
	// node3->data = 4;
	// enqueue(node3);
	...
	// hlist_node* hnode = (hlist_node*)malloc(sizeof(hnode));
	// hash_queue_add(hnode, 777);
	// struct timeval time;
	// for (int i = 0; i < 100000000; i++) {
	// 	gettimeofday(&time, NULL);
	// 	if (i % 1000000 == 0)printf("time: %d %lf\n", time.tv_sec, time.tv_usec);
	// }
}
